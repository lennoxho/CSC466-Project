...
namespace Utils {
    ...
    void simulated_annealing(Chip &chip, std::int64_t num_iter, std::size_t num_swap_per_temperature, double hot, double cooling_factor, metric_consumer* met = nullptr);
